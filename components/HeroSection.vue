<template>
    ...
    class="pt-[24px] max-w-[1440px] mx-auto px-[20px] ">
            ...
            <div class="h-full flex flex-col justify-center md:justify-start">
                <div class="text-white flex flex-col  gap-[24px] px-[20px] md:px-[64px] md:pt-[160px] ">
                    <div class="lg:w-[728px] border-t border-b border-white">
                        ...
                        data-aos-delay="900"
                        data-aos-offset="0"
                        class="  telegraf text-[40px] md:text-[56px] py-[8px] font-[400] leading-[67.2px]">Turn Challenges into <span class="text-primaryYellow">Opportunities</span> with OCMC</h1>
                    </div>
                    <div
                    data-aos="fade-right"
