            ...
            <div class="h-full flex flex-col justify-center md:justify-start">
                <div class="text-white flex flex-col  gap-[24px] px-[20px] md:px-[64px] md:pt-[160px] ">
                    <div class="lg:w-[728px] border-t border-b border-white">
                        <h1 class="  telegraf text-[40px] md:text-[56px] py-[8px] font-[400] leading-[67.2px]">Turn Challenges into <span class="text-primaryYellow">Opportunities</span> with OCMC</h1>
                    </div>

                    <p class="md:w-[488px] leading-[24px]">With OCMC securing public contracts will no longer be a daunting task but a strategic step towards your business growth.</p>

                    <Nuxt-link  to="/contact">
                        <button class="bg-white text-baseBlack py-[14px] px-[32px] rounded-[1000px]">
                            Get in touch
