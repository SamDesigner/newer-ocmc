        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-[40px] ">
            ...
            <div class="py-[24px] flex flex-col gap-[16px]">
                ...
                <p class="text-[16px] font-[400] leading-[24px] text-coolerGray">
                    To pioneer positive change and sustainable growth in healthcare and social care, setting new standards of excellence in tender writing, audits, compliance, and consulting services.
                </p>
            </div>
        </div>
