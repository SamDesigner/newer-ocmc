        ...
        <div class="flex flex-col gap-[80px]">
            ...
            <div class=" mx-auto grid grid-cols-1 md:grid-cols-2 lg:flex  justify-center gap-[48px]">
                <div class="lg:w-[400px] flex flex-col gap-[16px] p-[24px] custom_shadow rounded-[12px]">
                    ...
                    <p class="text-coolerGray text-[16px] font-[300] leading-[24px] text-center">
                        Easily find and apply for public contracts with our comprehensive database and user-friendly search and filtering options.
                    </p>
                ...
                <div class="lg:w-[400px] flex flex-col gap-[16px] p-[24px] custom_shadow rounded-[12px]">
                    ...
                    <p class="text-coolerGray text-[16px] font-[300] leading-[24px] text-center">
                        Receive personalized contract recommendations based on your business needs and preferences.
                    </p>
