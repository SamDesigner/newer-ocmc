        ...
        <div class="flex gap-[32px] flex-col-reverse lg:flex-row items-center">
            <div class="flex flex-col gap-[32px] flex-1">
                <div class="border-y border-lightBlue pt-[18px] pb-[16px]">
                    <h1 class="text-coolGray text-[32px] font-[400] leading-[41px] telegraf">Unlock the Potential of Your Business with OCMC's Services</h1>
                </div>
                ...
                <div class="grid lg:grid-cols-2 gap-[24px]">
                    <div class="custom_shadow flex flex-col gap-[16px] rounded-[12px] p-[24px]">
                        <div>
